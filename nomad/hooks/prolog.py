...
Installation:
    1. Copy to /etc/slurm/prolog.d/nomad_score.py
    2. Make executable: chmod +x nomad_score.py
    3. Add to slurm.conf: Prolog=/etc/slurm/prolog.d/nomad_score.py
...
# Configuration
DB_PATH = Path("/var/lib/nomad/nomad.db")
LOG_FILE = Path("/var/log/nomad/prolog.log")
ALERT_FILE = Path("/var/log/nomad/high_risk_jobs.log")
...
def setup_logging():
    ...
    return logging.getLogger('nomad.prolog')
