...
![Figure 1: NØMAD system architecture](figures/architecture.png)
...
![Figure 2: NØMAD web dashboard](figures/dashboard.png)
*Figure 2: NØMAD web dashboard showing real-time cluster status. Panel A displays compute partition metrics, Panel B shows high-memory partition status, Panel C presents GPU partition health, and Panel D visualizes the job similarity network. The interface provides at-a-glance monitoring for HPC administrators.*
...
| Persistent identifier: | https://pypi.org/project/nomad-hpc/0.3.4/ |
...
|---|---|
| Name: | GitHub |
| Identifier: | https://github.com/jtonini/nomad |
| Licence: | AGPL-3.0-or-later |
...
**Research Applications**: The similarity network approach provides a framework for studying HPC failure patterns. The community data export feature (`nomad community export`) enables cross-institutional research by generating anonymized datasets suitable for collaborative analysis.

**Educational Use**: The demo mode and clear architecture make NØMAD suitable for teaching HPC administration and monitoring concepts.
...
### Support
- GitHub Issues: https://github.com/jtonini/nomad/issues
- Email: jtonini@richmond.edu
- Documentation: https://github.com/jtonini/nomad#readme
