...
\begin{tabular}{ll}
Name: & GitHub \\
Identifier: & \url{https://github.com/jtonini/nomad} \\
Licence: & AGPL-3.0-or-later \\
...
\subsection*{Support}
\begin{itemize}
\item GitHub Issues: \url{https://github.com/jtonini/nomad/issues}
\item Email: jtonini@richmond.edu
\item Documentation: \url{https://github.com/jtonini/nomad\#readme}
\end{itemize}
